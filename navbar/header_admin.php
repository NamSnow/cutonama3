...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <div class="flex md:order-2">
    ...
    <form action="/cutonama3/admin/index.php" method="GET" class="relative hidden md:block">
      <input 
        type="text" 
        id="search-navbar" 
        name="search" 
      ...
      >
      <input type="hidden" name="filter" value="<?php echo htmlspecialchars($filterType ?? 'all'); ?>">
    </form>
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
      <form action="/cutonama3/admin/index.php" method="GET" class="relative mt-3 md:hidden">
