...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$error && (empty($title) || empty($summary) || empty($content))) {
    ...
    if (!$error) {
        try {
            ...
            $_SESSION['success_message'] = "Đã thêm tin tức thành công!";
            ...
            header("Location: create.php"); // Chuyển hướng lại về form với lỗi
            exit();
        }
    } else {
...
<head>
    ...
    <title>Admin - Thêm tin tức trang chính</title>
...
<body class="bg-gray-100 py-10">
    <div class="max-w-4xl mx-auto p-8 bg-white rounded-xl shadow-2xl">
        <h1 class="text-3xl font-extrabold text-gray-800 mb-8 text-center">Thêm tin tức trang chính</h1>
        ...
        <form method="POST" action="create.php" class="space-y-6">
            ...
            <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
                ...
                <input
                    ...
                    required
                    class="shadow-sm appearance-none border border-gray-300 rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
                    placeholder="http://example.com/hinh-anh-tin-tuc.jpg"
                >
                <p class="text-sm text-gray-500 mt-2">Vui lòng dán một URL ảnh hợp lệ (ví dụ: từ các trang báo điện tử, thư viện ảnh trực tuyến).</p>
            </div>
